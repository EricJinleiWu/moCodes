...
static void tstDecodeVideo2Pic(const char * videoFilepath, const char * outPicDir, const OUTPUT_PICTYPE picType)
{
    ...
    dbgDebug("call decodeVideo2Pic now.\n");
...
//    tstDecodeVideo2Pic("./H264Files/slamtv10.264", "./outPicFiles/pgm/slamtv10.264/", OUTPUT_PICTYPE_PGM);
    tstDecodeVideo2Pic("./H264Files/slamtv10.264", "./outPicFiles/jpg/slamtv10.264/", OUTPUT_PICTYPE_JPG);
//    tstDecodeVideo2Pic("./H264Files/zhihui_0612_16min_47seconds.h264", "./outPicFiles/jpg/zhihui_0612_16min_47seconds/", OUTPUT_PICTYPE_JPG);
